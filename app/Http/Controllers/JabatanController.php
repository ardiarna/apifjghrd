...
class JabatanController extends Controller
{
    ...
    public function create(Request $req) {
        ...
        return $this->createdResponse($data, 'Jabatan berhasil dibuat');
    }
    ...
    public function update(Request $req, $id) {
        ...
        return $this->successResponse($data, 'Jabatan berhasil diubah');
    }

    public function delete($id) {
        $data = $this->repo->delete($id);
        if($data == 0) {
            return $this->failRespNotFound('Jabatan tidak ditemukan');
        }
        return $this->successResponse($data, 'Jabatan berhasil dihapus');
    }
