...
class PotonganController extends Controller
{
    ...
    public function deleteAll(Request $req) {
        ...
        if($data == 0) {
            return $this->failRespNotFound("Potongan tahun {$tahun} bulan {$bulan} tidak ditemukan");
        }
        return $this->successResponse($data, "Potongan tahun {$tahun} bulan {$bulan} sebanyak {$data} data berhasil dihapus");
    }
